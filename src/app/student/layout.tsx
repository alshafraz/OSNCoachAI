...
import { Brain, LayoutDashboard, Award, Flame, User, LogOut, Compass, Settings } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-6">
          <div className="flex items-center gap-2 md:hidden">
            ...
            <span className="font-heading font-extrabold text-sm">MathOSN</span>
          </div>

          <div className="flex items-center gap-4 ml-auto">
            {/* Gamified stats */}
            <div className="flex items-center gap-1.5 px-3 py-1 bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 rounded-full text-xs sm:text-sm font-bold border border-amber-200/50 dark:border-amber-900/30">
