// src/application/content-generation/services/generators/ExplanationGenerator.ts
...
export class ExplanationGenerator {
  ...
  async generate(request: GenerationRequest): Promise<GeneratedContent> {
    ...
    const response = await this.llmProvider.generate({
      ...
      temperature: rendered.temperature ?? acgpConfig.explanationTemperature,
    ...
    const content: GeneratedContent = {
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
      promptVersion: acgpConfig.promptVersions.explanation,
